document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        en: {
            description: 'Over the years, I’ve kept journals, reading notes, and sketches—records of my thoughts and daily life. From time to time, I’ve found myself wanting to share some of these with others. After a lot of thought about how best to share them, I decided to create this small space. What you’ll find here might be personal reflections, critiques, poetry, short stories, or illustrations—who knows?<br><br>Life is unpredictable, and even tomorrow feels uncertain. But as I continue to gather and organize my thoughts and records, I hope something will eventually come into clearer focus.<br><br><br><br><br><br><br><br><br>',
            instagram: '@yejin.wip',
            website: '▫ yejinschoi.com ↗',
        },
        ko: {
            description: '오랜 기간 일기, 독서노트, 낙서 등의 기록들을 해오면서 때로는 공유하고 나누고 싶은 마음과 생각들이 있었습니다. 어떻게 나눌 수 있을까 그 형태를 오래 고민하다가 이렇게 작은 공간을 만들어봤어요. 사적인 글이 될 수도, 비평이 될 수도, 시나 소설, 그림이 될 수도 있겠네요. <br>당장의 내일도 모르겠는 인생이지만, 생각과 기록이 쌓이게 되면 무언가는 선명해질 수도 있기를 기대해 봅니다.<br><br><br><br><br><br><br><br><br>',
            instagram: '@yejin.wip',
            website: '▫ yejinschoi.com &#x2197;',
        }
    };
