document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        ...
        ko: {
            description: '끈<br><br>세상에 대해 한없이 다정하고 싶다가도<br>문득 이무 이유 없이 그 끈을 툭 놓아버리듯,<br>될대로 되라며 소리치고 싶을 때가 있다<br><br>바람에 성난 파도처럼 울렁이는 그 마음은<br>이렇게도 저렇게도 살 수 없어 몸부림치는,<br>빨간불의 횡단보도 사이에 갇혀버린 방황 같은 것<br><br>그 마음을 어찌할 줄 몰라<br>끝내 어디로도 나아가지 못한 채<br>여전히 이 자리에서 발만 동동 구를 뿐<br><br>- 2025년 02월 25일<br><br><br>',
